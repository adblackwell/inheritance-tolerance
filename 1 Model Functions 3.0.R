...
makeparams<-function(n0=1000, #starting population size
                     ...
                     reprodrate=0.015, #Monthly risk of reproduction for reproductive age individual
                     gestation=12, #Minimum time between reproductions, representing gestation and lactation
                     R0=0.5, #Poisson distribution lambda (mean) number of individuals an infection infects each month
...
paramscheck<-function(params,xmax1=70,xmax2=70){
  with(params,{
